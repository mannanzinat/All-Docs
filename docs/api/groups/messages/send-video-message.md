...
Send a message that includes a video. Provide the video via a publicly accessible URL in the media_url parameter. 

You can optionally include caption text in the message parameter.

****
> 💡 **Note:** Supported video formats: MP4, 3GPP. Maximum file size: 16MB.
...
```http
{
  ...
  "message_type": "video",
  "message": "Here is a video for you!",
  "media_url": "https://rapiwa.com/xyz.mp4",
  "mimetype": "video/mp4"
}
```
